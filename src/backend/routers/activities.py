...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'none' for activities with no difficulty)
    """
    ...
    if difficulty:
        if difficulty == "none":
            # Filter for activities that have no difficulty_level field in the database
